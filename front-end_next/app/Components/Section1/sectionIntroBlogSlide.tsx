...
const Slide = () => {
    return (
        <div className='grid md:grid-cols-2 sm:gap-10'>
            <div className='image'>
                <Link href={'/'}>
                    <Image src={'/images/img1.png'} width={600} height={600} alt='Picture Blog' />
                </Link>
            </div>
            <div className='info flex justify-center flex-col'>
                <div className='cat'>
                    <Link href={'/'}>
                        <span className='text-orange-600 hover:text-orange-800'>Criado em:</span>
                    </Link>
                    <Link href={'/'}>
                ...
                <div className='title'>
                    <Link href={'/'}>
                        <p className='text-3xl md:text-6xl font-bold text-gray-800 hover:text-gray-600'>Navegando Pelos Caminhos da Inspiração e Sabedoria</p>
                    </Link>
                </div>
